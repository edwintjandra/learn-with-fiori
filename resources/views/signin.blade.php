...
<section class="bg-gradient-to-r from-[#EEF2F5] to-[#E7F5FF]">
    <form class="flex flex-col gap-2 justify-center items-center h-screen w-screen" action="">
        ...
        <p class="font-nunito text-base text-custom-black font-normal">Don't have an account? <span class="font-bold hover:text-custom-hover"><a href=""> Sign up</a></span></p>
    </form>
