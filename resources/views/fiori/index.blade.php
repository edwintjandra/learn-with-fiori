                                ...
                                <li>
                                    <details class="group rounded-md bg-[#E9F5FC]"
                                        ...
                                        <summary
                                            ...
                                            <span class="text-custom-blue font-nunito text-base font-medium">Answer
                                                Recommendations</span>
                                        </summary>

                                        <article
                                            class="px-4 pb-4 flex flex-col justify-between text-justify w-full text-sm">
                                            <p class="text-green-400 font-bold mb-1">Soft Answer:</p>
                                            <a href=""
                                                class="border border-green-400 p-4 rounded-md cursor-pointer hover:bg-[#E3F0F8]">
                                                <ul class=" pl-2 list-disc">
                                                    <li>Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                                                        Voluptas, molestias.</li>
                                                    <li>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nulla,
                                                        accusantium!</li>
                                                </ul>
                                            </a>
                                            <p class="text-blue-400 font-bold mt-3 mb-1">Neutral Answer:</p>
                                            <a
                                                class="border border-blue-400 p-4 rounded-md cursor-pointer hover:bg-[#E3F0F8]">
                                                <ul class="pl-2 list-disc">
                                                    <li>Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                                                        Voluptas, molestias.</li>
                                                    <li>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nulla,
                                            ...
                                            <a
                                                class="border border-red-400 p-4 rounded-md cursor-pointer hover:bg-[#E3F0F8]">
                                                <ul class="pl-2 list-disc">
                                                    <li>Lorem ipsum dolor sit, amet consectetur adipisicing elit.
                                                        Voluptas, molestias.</li>
                                                    <li>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nulla,
                                ...
                                <li>
                                    <details class="group rounded-md bg-[#E9F5FC]"
                                        ...
                                        <summary
                                            ...
                                            <span class="text-custom-blue font-nunito text-base font-medium">Question
                                                summarized</span>
                                        </summary>
