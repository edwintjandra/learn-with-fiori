<div class="prompts content flex-grow flex flex-col mt-12 pb-28 h-[600px] items-center overflow-y-auto">
    <div class="ml-48 flex-col w-[820px]">
        ...
        <div class="flex gap-0 items-start mb-5">
            ...
            <button class="copy-button text-custom-grey focus:outline-none mt-1">
        ...
        <div class="flex gap-2 items-start mb-5">
            ...
            <div class="flex flex-col">
                <p class="text-left font-nunito text-base text-wrap">Lorem, ipsum dolor. Lorem ipsum, dolor sit amet </p>
                <button class="copy-button text-custom-grey focus:outline-none mt-1">
                <svg width="18" height="18" viewBox="0 0 24 24" class="fill-none hover:fill-custom-hover" xmlns="http://www.w3.org/2000/svg"><path opacity="0.16" d="M8 7H20V19C20 19.5304 19.7893 20.0391 19.4142 20.4142C19.0391 20.7893 18.5304 21 18 21H10C9.46957 21 8.96086 20.7893 8.58579 20.4142C8.21071 20.0391 8 19.5304 8 19V7Z" class="fill-[#66C2FF] hover:fill-custom-hover"/><path d="M16 3H4V16" class="stroke-[#919394] hover:stroke-[#66C2FF]" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M8 7H20V19C20 19.5304 19.7893 20.0391 19.4142 20.4142C19.0391 20.7893 18.5304 21 18 21H10C9.46957 21 8.96086 20.7893 8.58579 20.4142C8.21071 20.0391 8 19.5304 8 19V7Z" class="stroke-[#919394] hover:stroke-[#66C2FF]" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </button>
    ...
    <!-- customer questions -->
        <div class="flex gap-0 items-start mb-5">
            <img src="{{ asset('assets/profile.svg') }}" alt="" class="w-12 pr-1.5">
            <div class="flex flex-col">
                <p class="text-left font-nunito text-base text-wrap">Lorem, ipsum dolor. Lorem ipsum, dolor sit amet Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsa, repellendus.</p>
                <button class="copy-button text-custom-grey focus:outline-none mt-1">
                <svg width="18" height="18" viewBox="0 0 24 24" class="fill-none hover:fill-custom-hover" xmlns="http://www.w3.org/2000/svg"><path opacity="0.16" d="M8 7H20V19C20 19.5304 19.7893 20.0391 19.4142 20.4142C19.0391 20.7893 18.5304 21 18 21H10C9.46957 21 8.96086 20.7893 8.58579 20.4142C8.21071 20.0391 8 19.5304 8 19V7Z" class="fill-[#66C2FF] hover:fill-custom-hover"/><path d="M16 3H4V16" class="stroke-[#919394] hover:stroke-[#66C2FF]" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/><path d="M8 7H20V19C20 19.5304 19.7893 20.0391 19.4142 20.4142C19.0391 20.7893 18.5304 21 18 21H10C9.46957 21 8.96086 20.7893 8.58579 20.4142C8.21071 20.0391 8 19.5304 8 19V7Z" class="stroke-[#919394] hover:stroke-[#66C2FF]" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                </svg>
            </button>
                    ...
                    <ul class="flex flex-col gap-4">
                        <li>
                            <details class="group rounded-md bg-[#E9F5FC]" style="box-shadow: 2px 4px 12px 0px rgba(181, 184, 185, 0.14);">
                                ...
                                <!-- li jgn diapus ntar copasnya berantakan -->
                                ...
                                <p class="text-green-400 font-bold mb-1">Soft Answer:</p>
                                    <a id="soft-answer" href="javascript:void(2)" class="border border-green-400 p-4 rounded-md cursor-pointer hover:bg-[#E3F0F8]">
                                        <ul class=" pl-2 list-disc">
                                            <li>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptas, molestias. soft</li>
                                    ...
                                    <a id="neutral-answer" href="javascript:void(1)" class="border border-blue-400 p-4 rounded-md cursor-pointer hover:bg-[#E3F0F8]">
                                        <ul class="pl-2 list-disc">
                                            <li>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptas, molestias. neutral</li>
                                            <li>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nulla, accusantium!</li>
                                        </ul>
                                    </a>
                                    <p class="text-red-400 font-bold mt-3 mb-1">Straight Answer:</p>
                                    <a id="straight-answer" href="javascript:void(0)" class="border border-red-400 p-4 rounded-md cursor-pointer hover:bg-[#E3F0F8]">
                                        <ul class="pl-2 list-disc">
                                            <li>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Voluptas, molestias. straight</li>
                                            <li>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nulla, accusantium!</li>
                                            <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita, ipsa!</li>
                                        </ul>
                                    </a>
                                </article>
                            </details>
